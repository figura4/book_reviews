<?php
	...
	$mcImageManagerConfig['thumbnail.folder'] = "thumbnails_small"; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
	$mcImageManagerConfig['thumbnail.prefix'] = "thmbs_"; // 
	...
	$mcImageManagerConfig['upload.autoresize_jpeg_quality'] = 85; // Force max width/height, IM will rescale uploaded images.
	$mcImageManagerConfig['upload.max_width'] = "150";
	$mcImageManagerConfig['upload.max_height'] = "300"; // Only if force_width_height is true
	...
	$mcImageManagerConfig['authenticator.login_page'] = "/user/login";
